...
void process_image_callback(const sensor_msgs::Image img)
{
    ...
    // Then, identify if this pixel falls in the left, mid, or right side of the image
        int ball_position = i % img.step;
        
        if (ball_position >= 0 && ball_position <= left_edge){
          turn_left = true;
          turn_right = false;
          move_forward = false;
          break;
        }
        else if (ball_position > left_edge && ball_position <= mid_edge){
          move_forward = true;
          turn_right = false;
          turn_left = false;
          break;
        }
        else if (ball_position > mid_edge && ball_position <= right_edge){
          turn_right = true;
          turn_left = false;
          move_forward = false;
          break;
